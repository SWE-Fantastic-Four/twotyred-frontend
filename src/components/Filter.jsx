      ...
      <div className="entiredropdown absolute z-10">
        {isClicked ? (
          <div className="dropdown h-[72px] w-[195px] border-black stroke-solid border-[3px] rounded-xl overflow-hidden ">
            ...
            <div
              className="option2 h-[35px] hover:bg-[#EFEFEF] flex cursor-pointer items-center justify-between"
              onClick={() => setCurrentView("Most Recent")}
            >
              <p className="option2 font-[Roboto] text-[19px] font-medium leading-[22px] pl-[20px] ">
                Most Recent
              </p>
