...
const SmallBox = ({ children, className }) => {
  return (
    <button 
      className={`flex flex-col gap-[10px] mt-[10px] rounded-[10px] w-full px-[10px] py-[6px] text-[20px] text-[#0c0c0c] leading-[23px] box-border hover:border hover:py-[5px] hover:px-[9px] ${className}`}
    >
      {children}
    </button>
  );
...
const RouteDescription = () => {
  return (
    <>
     <div className="flex flex-col m-[10px] w-[400px] h-[593px] bg-[#918d8db4] p-[20px] rounded-[10px] overflow-hidden">
        ...
        <div className="flex flex-col flex-grow bg-white m-[10px] rounded-[10px]  text-black text-[20px] p-[16px]">
            ...
            <div className="flex flex-row justify-between">
              <img src={sun} className="" />
               <div className="flex flex-col items-end">
                 <h className="mt-[20px] text-[43px] text-[#565150] self-end">29 Aug</h>
          ...
          <SmallBox  className="bg-[#ddd48576]">
             <p className="text-[#565150] m-[10px]">Route distance: 10.00 km</p>
          </SmallBox>
